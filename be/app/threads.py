...
def thread_config(thread_id: str) -> dict[str, Any]:
    """ "Sets thread id as a configurable to be passed to the graph"""
    # ? how are other configs passed?
    return {"configurable": {"thread_id": thread_id}}


def thread_has_checkpoint(snapshot: StateSnapshot) -> bool:
    """Returns True if thread has a valid checkpoint otherwise False"""
...
def _parse_before_cursor(thread_id: str, before: Any) -> dict[str, Any] | None:
    if before is None:
        return None
